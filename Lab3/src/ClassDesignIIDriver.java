                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                System.out.println("i like cakes");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                }
...
//		a.setDenom(5);
		...
		System.out.println("b.den: " + b.denominator);
		
		
		//(3)which of the following code is correct to change the fraction a? (The uncommented one)
		//a.add(b);
		a = a.add(b);
	...
	private static void math2Driver() {
		...
		System.out.println(" And the larger of the two is " + Math2.max(10.34,10.34000000001));
	...
	public static void mutate(@SuppressWarnings("ParameterCanBeLocal") int z) {  //does it matter that I called my input data "z" here? No.
		z = -1000;  //if z is only a copy, this won't affect the variable a's value in main.

        //this.foo = -1000;
        // why does the line above cause compiler errors?
        // foo is an instance variable, and cannot be accessed from a static method
	}
	...
	public static void mutate(Dimension c) {  
        ...
        // The values in the Dimension object are changed.
	...
	public static void moneyDriver() {
			...
			try {
                ...
                System.out.print("Success in disallowing new Money(0, -1)\n");
			}
			try {
				m5 = new Money(-1, 0);
				System.out.printf("Failed in disallowing new Money(-1, 0): %s\n", m5);
			} catch (IllegalStateException e) {
                System.out.print("Success in disallowing new Money(-1, 0)\n");
			}
			try {
				m5 = new Money(0, -100);
				System.out.printf("Failed in disallowing new Money(0, -100): %s\n", m5);
			} catch (IllegalStateException e) {
                System.out.print("Success in disallowing new Money(0, -100)\n");
			}
			try {
				m5 = new Money(-1.00);
				System.out.printf("Failed in disallowing new Money(-1.00): %s\n", m5);
			} catch (IllegalStateException e) {
                System.out.print("Success in disallowing new Money(-1.00)\n");
			}
			System.out.println();
 ...
 * A primitive gets passed by value, while an object gets passed by reference.
 *
 * 2. When a primitive is passed to a method, does the scope of that primitive change (i.e., grow to include the called method)?
 * No. A copy of that is created, therefore restricting the scope to the block it it was allocated in.
 *
 * 3. What about when an object is passed to a method?
 * Technically no. You cannot reference by the name in the above stack method, but the data can be referenced.
 *
 * 4. How then would you describe the scope of an object that has been passed to a method?
 * Local to the field.
 */